    ...
    <section className="container space-y-8 px-4 py-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your {type} metrics over the past week
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardContent>
          <div className="space-y-4">
            {type === "running" && (
              <>
                <p>
                  🎯 Target Pace: Based on your recent performance, try
                  maintaining a pace of 5.0 min/km for your next run.
                </p>
                <p>
                  💪 Suggested Distance: Aim for 7.5 km on your next run to
                  gradually increase your weekly mileage.
                </p>
                <p>
                  ❤️ Heart Rate Zones: Your average heart rate is optimal. Keep
                  maintaining this intensity level.
                </p>
              </>
            )}
            {type === "cycling" && (
              <>
                <p>
                  🚴‍♂️ Target Speed: Try to maintain an average speed of 23 km/h
                  on your next ride.
                </p>
                <p>
                  🎯 Distance Goal: Consider a 25 km ride this weekend to
                  challenge yourself.
                </p>
                <p>
                  📈 Progress: Your cycling endurance is improving. Keep up the
                  consistent effort!
                </p>
              </>
            )}
            {type === "sleep" && (
              <>
                <p>
                  ⏰ Optimal Sleep Time: Your best sleep quality occurs when you
                  sleep between 10 PM and 6 AM.
                </p>
                <p>
                  🌙 Deep Sleep: Your deep sleep duration is good. Maintain your
                  current pre-sleep routine.
                </p>
                <p>
                  📱 Recommendation: Consider avoiding screen time 1 hour before
